...
const socialLinks = [
    { href: "https://discord.gg/nCEgBUW4vj", icon: "/social/discord_icon_bg.png", alt: "Discord" },
    { href: "https://tiktok.com/@nocnydominator2", icon: "/social/tiktok_icon_bg.png", alt: "TikTok" },
    { href: "https://www.youtube.com/@mvciejjj", icon: "/social/youtube_icon_bg.png", alt: "YouTube" },
];
    ...
    return (
        <header className="top-0 z-40 w-full flex justify-center px-6">
            <div className="w-full max-w-[1480px] h-[88px] relative flex items-center justify-between">
                ...
                <div className="absolute left-1/2 top-[70px] -translate-x-1/2 -translate-y-1/2 flex justify-center">
                    <Link href="/" className="">
                        <Image
                            src="/logo_main.png"
                            alt="Logo"
